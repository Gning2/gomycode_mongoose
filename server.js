...
const arrayOfPeople = [
    { name: 'Saliou GNING', age: 27, favoriteFoods: ['Riz au poisson', 'Pastel'] },
    { name: 'Ibra GNING', age: 30, favoriteFoods: ['Riz au poulet', 'Salade'] },
    { name: 'Moussa DIANE', age: 27, favoriteFoods: ['Salade'] }
];
Person
...
Person
    .findOneAndUpdate({name: 'Saliou GNING'}, { age: 20 },{ new: true })
    .then(doc =>{
